...
def main():
    ...
    R_B = R_raw_proj @ R_stab_proj.T
    
    # We sweep roll offsets from -8 to -16 degrees
    for roll_deg in [-8, -10, -12, -14, -16]:
        ...
        out = projector.project_matrix(t_front, t_rear, R_B @ R_roll)
        path = f"/mnt/c/Users/me/.gemini/antigravity/brain/64681769-3704-4a64-a001-c7bedf088c94/scratch/horizon_roll_{abs(roll_deg)}.png"
